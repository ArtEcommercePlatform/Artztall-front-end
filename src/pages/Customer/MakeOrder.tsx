    ...
    try {
      ...
      if (response.success) {
        ...
        const paymentPayload = {
          ...
          userId: orderDetails.userId,
          currency: 'LKR',
          paymentMethodId: orderDetails.paymentMethod === 'credit' 
            ? 'pm_card_visa' 
        ...
        const paymentResponse = await apiClient.post<any>('/payments', paymentPayload);
        ...
        <div className="p-8 bg-gray-50">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2 text-gray-700">
              ...
              <p><strong className="text-green-800">Medium:</strong> {product.medium}</p>
              <p>
