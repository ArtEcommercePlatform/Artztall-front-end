...
const dummyArtPieces: ArtPiece[] = [
  ...
  },
  {
    ...
    price: 1500,
    image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR4629jjuWbNn8181Vd71QfCVGebs-u7ta1Qg&s',
    category: 'Landscape',
    likes: 312,
    dimensions: '36" x 48"',
    medium: 'Watercolor'
  },
  {
    ...
    artist: 'Alex Wong',
    price: 750,
    image: 'https://w0.peakpx.com/wallpaper/282/712/HD-wallpaper-don-t-trash-your-dreams-dreams-digital-art-toys.jpg',
    category: 'Digital',
    likes: 167,
    dimensions: '20" x 20"',
  ...
  },
  {
    ...
    price: 2200,
    image: 'https://media.craiyon.com/2023-06-29/f0126470d9604481b529a357abb6542c.webp',
    category: 'Portrait',
    likes: 423,
    dimensions: '24" x 36"',
    medium: 'Oil on Canvas'
  },
  {
    ...
    artist: 'David Kim',
    price: 980,
    image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRqzW7xS7QRTxGwssQ63GKDmRK-PNX14AKTaw&s',
    category: 'Abstract',
    likes: 278,
    dimensions: '30" x 30"',
    medium: 'Mixed Media'
  ...
  const handleFilterChange = (filterType: keyof FilterOptions, value: string) => {
    ...
    if (newFilters.priceRange !== 'All') {
      filtered = filtered.filter(art => {
        ...
        if (newFilters.priceRange === 'LKR 1000-LKR2000') return art.price >= 1000 && art.price <= 2000;
            ...
            <div className="relative">
              ...
              <div className="absolute top-4 right-4 flex space-x-2">
                ...
                >
                  <Heart 
                    size={20} 
                    className={liked[art.id] ? "fill-red-500 text-red-500" : "text-gray-600"}
                  />
                </button>
