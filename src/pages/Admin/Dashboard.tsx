    ...
    <div className="flex flex-col h-screen overflow-hidden bg-gradient-to-br from-green-50 via-blue-50 to-purple-50">
      ...
      <div className="container mx-auto px-4 py-8 flex-grow overflow-y-auto custom-scrollbar">
        ...
        <div className="mb-8 flex justify-between items-center">
          ...
          <div className="flex space-x-4">{/* Filter button removed */}</div>
        </div>
              ...
              {notifications.map((notification) => (
                ...
                >
                  <div className="flex items-start">
                    <AlertCircle
                      className={`w-5 h-5 mr-4 ${notification.isRead ? "text-gray-400" : "text-green-600"}`}
                    />
                    ...
                    <div
                      className={`w-2 h-2 rounded-full ${notification.isRead ? "bg-gray-200" : "bg-green-500"}`}
                    />
                  </div>
                </div>
              ))}
